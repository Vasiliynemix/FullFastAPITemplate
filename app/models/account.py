...
from app.models.base import Base, TimestampCreatedMixin, TimestampMixin, UUIDPrimaryKeyMixin
...
class Transaction(UUIDPrimaryKeyMixin, TimestampCreatedMixin, Base):
    ...
    acquirer: Mapped[str] = mapped_column(String(20), nullable=False)
